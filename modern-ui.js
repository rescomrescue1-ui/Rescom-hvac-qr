/* Res-Com HVAC QR v30.15 — Diagnostics, PIN Recovery, Offline Photos & QR Audit */
(() => {
  "use strict";

  const MODERN_VERSION = "30.15";
  const MODERN_BUILD = "Aug 20, 2026 12:25 PM";
