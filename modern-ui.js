  ...
  function modernizePrintCenter(){
    ...
    try{
      renderQrLabels=function(ids){
        ...
        area.innerHTML=generatedLabelIds.map((id,i)=>`<div class="print-label"><h2>RES-COM HVAC</h2><div class="label-sub">Equipment Service History</div><div class="qr-cell" id="qrLabel_${i}"></div><div class="qr-code-text">QR CODE</div><div class="qr-code-id mono">${escapeHTML(id)}</div><div class="tech-only">FOR SERVICE TECHNICIANS</div><div class="label-footer">Scan or search this code in the Res-Com HVAC QR app.</div></div>`).join("");
